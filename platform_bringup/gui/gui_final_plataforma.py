...
class Platform_GUI(Gtk.Window):
    ...
    def arranque(self, button):
        ...
        if node_is_active == True:
            print 'PAL Navigation is on. Powering off'
    ...
    def start_smach(self,button):
        ...
        if node_is_active == False and smach_act == False:
            self.launchTerminal("roslaunch platform_bringup tof_nav_smach.launch", True)
